...
@onready var node_viewport = $ScreenOnViewport
@onready var node_quad = $Quad
@onready var node_area = $Quad/Area3D

@onready var off_viewport := $ScreenOffViewport
...
func turn_off() -> void:
	is_on = false
	node_quad.mesh.material.albedo_texture.viewport_path = off_viewport.get_path()
